...
/**
 * EquipmentUnitListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EquipmentUnitListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EquipmentUnitListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of this equipment unit.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this equipment unit.
     *
     * @return $this
     */
