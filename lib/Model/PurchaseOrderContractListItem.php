...
/**
 * PurchaseOrderContractListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PurchaseOrderContractListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PurchaseOrderContractListItem';
     ...
     * Sets type
     *
     * @param int $type Type of the contract. (0 = Permanent, 1 = Directing)
     *
     * @return $this
     */
     ...
     * Sets purchase_type
     *
     * @param int $purchase_type The type of purchase. (2 = Purchase Order, 4 = Equipment, 5 = Material, 6 = Miscelaneous)
     *
     * @return $this
     */
     ...
     * Sets delivery_date
     *
     * @param string $delivery_date Delivery date of the purchase order in ATOM-format.
     *
     * @return $this
     */
     ...
     *
     * @param string $delivery_date_text Delivery date of the purchase order as free-form text.
     *
     * @return $this
     */
     ...
     *
     * @param string $outstanding_costs Outstanding costs for the purchase order.
     *
     * @return $this
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PurchaseOrderContractListItem., must be smaller than or equal to 255.');
        }
