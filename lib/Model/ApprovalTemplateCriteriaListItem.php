...
/**
 * ApprovalTemplateCriteriaListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApprovalTemplateCriteriaListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApprovalTemplateCriteriaListItem';
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'type' => 'int',
        'workflow' => '\Swagger\Client\Model\NestedApprovalTemplateWorkflowListItem',
     ...
     * Sets id
     *
     * @param int $id The ID of this approval criteria.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of this approval criteria.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Description of the approval criteria.
     *
     * @return $this
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ApprovalTemplateCriteriaListItem., must be smaller than or equal to 255.');
        }
     ...
     * Sets type
     *
     * @param int $type Type of this approval criteria.
     *
     * @return $this
     */
     ...
     * Gets workflow
     *
     * @return \Swagger\Client\Model\NestedApprovalTemplateWorkflowListItem
     */
     ...
     * Sets workflow
     *
     * @param \Swagger\Client\Model\NestedApprovalTemplateWorkflowListItem $workflow workflow
     *
     * @return $this
     */
     ...
     *
     * @param string $price_lower_bound Price lower bound of the approval criteria.
     *
     * @return $this
     */
     ...
     *
     * @param string $price_upper_bound Price upper bound of the approval criteria.
     *
     * @return $this
     */
     ...
     *
     * @param bool $delivery_ticket_matches_invoice_amount Whether or not the delivery ticket has to match the invoice amount.
     *
     * @return $this
     */
