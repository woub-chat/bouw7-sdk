...
/**
 * WasteUnitListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WasteUnitListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WasteUnitListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of this waste unit.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this waste unit.
     *
     * @return $this
     */
