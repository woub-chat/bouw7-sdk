...
/**
 * QuotationConfirmationAttachmentListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QuotationConfirmationAttachmentListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuotationConfirmationAttachmentListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of the QuotationConfirmationAttachment.
     *
     * @return $this
     */
     ...
     * Sets file_name
     *
     * @param string $file_name The name of the file for the QuotationConfirmationAttachment.
     *
     * @return $this
     */
     ...
     * Sets file_hash
     *
     * @param string $file_hash The hash of the file for the QuotationConfirmationAttachment.
     *
     * @return $this
     */
