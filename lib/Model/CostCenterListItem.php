...
/**
 * CostCenterListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CostCenterListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CostCenterListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of the cost center.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code The code of the cost center.
     *
     * @return $this
     */
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 256)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CostCenterListItem., must be smaller than or equal to 256.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CostCenterListItem., must be smaller than or equal to 256.');
        }
