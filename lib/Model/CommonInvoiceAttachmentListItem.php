...
/**
 * CommonInvoiceAttachmentListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommonInvoiceAttachmentListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommonInvoiceAttachmentListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of CommonInvoiceAttachment.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of CommonInvoiceAttachment.
     *
     * @return $this
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CommonInvoiceAttachmentListItem., must be smaller than or equal to 256.');
        }
     ...
     * Sets file_name
     *
     * @param string $file_name The name of the file for the CommonInvoiceAttachment.
     *
     * @return $this
     */
     ...
     * Sets file_hash
     *
     * @param string $file_hash The hash of the file for the CommonInvoiceAttachment.
     *
     * @return $this
     */
