...
/**
 * HoursEstimatePerHourType Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HoursEstimatePerHourType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HoursEstimatePerHourType';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'hour_type' => '\Swagger\Client\Model\HourType',
        'hours' => 'string',
        'created_at' => 'string',
        'created_by' => 'string',
        'updated_at' => 'string',
     ...
     * Sets id
     *
     * @param int $id The ID of hours estimate per hour type.
     *
     * @return $this
     */
     ...
     * Sets hour_type
     *
     * @param \Swagger\Client\Model\HourType $hour_type hour_type
     *
     * @return $this
     */
     ...
     * Sets hours
     *
     * @param string $hours The hours estimated for the hour type.
     *
     * @return $this
     */
