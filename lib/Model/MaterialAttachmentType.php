...
/**
 * MaterialAttachmentType Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MaterialAttachmentType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MaterialAttachmentType';
     ...
     *
     * @param bool $from_booking_items Whether or not to generate the Material PDF based on booking items (false = based on project).
     *
     * @return $this
     */
