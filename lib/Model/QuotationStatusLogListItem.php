...
/**
 * QuotationStatusLogListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QuotationStatusLogListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuotationStatusLogListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of the quotation status log.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the quotation status log.
     *
     * @return $this
     */
