...
/**
 * ApprovalTemplateWorkflow Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApprovalTemplateWorkflow implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApprovalTemplateWorkflow';
    ...
    protected static $setters = [
        ...
        'is_deduplicated' => 'setIsDeduplicated',
    ...
    protected static $getters = [
        ...
        'is_deduplicated' => 'getIsDeduplicated',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_deduplicated'] = isset($data['is_deduplicated']) ? $data['is_deduplicated'] : null;
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApprovalTemplateWorkflow., must be smaller than or equal to 255.');
        }
     ...
     * Sets is_restricted
     *
     * @param bool $is_restricted Whether the criteria is restricted.
     *
     * @return $this
     */
    ...
    /**
     * Gets is_deduplicated
     *
     * @return bool
     */
    public function getIsDeduplicated()
    {
        return $this->container['is_deduplicated'];
    }

    /**
     * Sets is_deduplicated
     *
     * @param bool $is_deduplicated Whether the criteria has been deduplicated.
     *
     * @return $this
     */
    public function setIsDeduplicated($is_deduplicated)
    {
        $this->container['is_deduplicated'] = $is_deduplicated;
     ...
     * Sets approvers
     *
     * @param bool $approvers approvers
     *
     * @return $this
     */
