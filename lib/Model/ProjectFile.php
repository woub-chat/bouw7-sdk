...
class ProjectFile implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param int $id The ID of the project file.
     *
     * @return $this
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProjectFile., must be smaller than or equal to 255.');
        }
     ...
     * Sets information
     *
     * @param string $information The information of the project file.
     *
     * @return $this
     */
