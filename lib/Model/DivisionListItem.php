...
/**
 * DivisionListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DivisionListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DivisionListItem';
    ...
    public function setSalesInvoiceNumberPrefix($sales_invoice_number_prefix)
    {
        if (!is_null($sales_invoice_number_prefix) && (mb_strlen($sales_invoice_number_prefix) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_invoice_number_prefix when calling DivisionListItem., must be smaller than or equal to 3.');
        }
