...
/**
 * DepartmentListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DepartmentListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DepartmentListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of this department.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Display name of the department.
     *
     * @return $this
     */
     ...
     * Sets color
     *
     * @param string $color Color used in things like calendars for items associated with this department.
     *
     * @return $this
     */
     ...
     * Sets is_active
     *
     * @param bool $is_active Whether this department is currently active.
     *
     * @return $this
     */
