...
/**
 * WasteListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WasteListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WasteListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of this waste.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this waste.
     *
     * @return $this
     */
