...
/**
 * DayOffPerEmployee Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DayOffPerEmployee implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DayOffPerEmployee';
     ...
     * Sets id
     *
     * @param int $id The unique identifier of dayOffPerEmployee.
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param string $start_date The start date of dayOffPerEmployee.
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param string $end_date The end date of dayOffPerEmployee.
     *
     * @return $this
     */
     ...
     * Sets remark
     *
     * @param string $remark The remark of dayOffPerEmployee.
     *
     * @return $this
     */
     ...
     * Sets hours
     *
     * @param string $hours The duration in hours of this dayOffPerEmployee.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param int $status The status of the dayOffPerEmployee.
     *
     * @return $this
     */
