...
/**
 * ResourceProjectSecurityLink Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResourceProjectSecurityLink implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceProjectSecurityLink';
     ...
     * Sets chapter_name
     *
     * @param string $chapter_name The name of the project security chapter.
     *
     * @return $this
     */
