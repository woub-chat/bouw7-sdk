...
/**
 * CondensedDivision Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CondensedDivision implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CondensedDivision';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sales_invoice_number_prefix']) && (mb_strlen($this->container['sales_invoice_number_prefix']) > 3)) {
    ...
    {
        if (!is_null($sales_invoice_number_prefix) && (mb_strlen($sales_invoice_number_prefix) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_invoice_number_prefix when calling CondensedDivision., must be smaller than or equal to 3.');
        }
