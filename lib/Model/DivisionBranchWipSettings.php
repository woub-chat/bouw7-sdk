...
/**
 * DivisionBranchWipSettings Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DivisionBranchWipSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DivisionBranchWipSettings';
    ...
    public function setGlAccountCodeSales($gl_account_code_sales)
    {
        if (!is_null($gl_account_code_sales) && (mb_strlen($gl_account_code_sales) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_sales when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeSalesDebit($gl_account_code_sales_debit)
    {
        if (!is_null($gl_account_code_sales_debit) && (mb_strlen($gl_account_code_sales_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_sales_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeSalesClosing($gl_account_code_sales_closing)
    {
        if (!is_null($gl_account_code_sales_closing) && (mb_strlen($gl_account_code_sales_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_sales_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodePurchase($gl_account_code_purchase)
    {
        if (!is_null($gl_account_code_purchase) && (mb_strlen($gl_account_code_purchase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_purchase when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodePurchaseDebit($gl_account_code_purchase_debit)
    {
        if (!is_null($gl_account_code_purchase_debit) && (mb_strlen($gl_account_code_purchase_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_purchase_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodePurchaseClosing($gl_account_code_purchase_closing)
    {
        if (!is_null($gl_account_code_purchase_closing) && (mb_strlen($gl_account_code_purchase_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_purchase_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeHours($gl_account_code_hours)
    {
        if (!is_null($gl_account_code_hours) && (mb_strlen($gl_account_code_hours) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_hours when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeHoursDebit($gl_account_code_hours_debit)
    {
        if (!is_null($gl_account_code_hours_debit) && (mb_strlen($gl_account_code_hours_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_hours_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeHoursClosing($gl_account_code_hours_closing)
    {
        if (!is_null($gl_account_code_hours_closing) && (mb_strlen($gl_account_code_hours_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_hours_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeMaterial($gl_account_code_material)
    {
        if (!is_null($gl_account_code_material) && (mb_strlen($gl_account_code_material) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_material when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeMaterialDebit($gl_account_code_material_debit)
    {
        if (!is_null($gl_account_code_material_debit) && (mb_strlen($gl_account_code_material_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_material_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeMaterialClosing($gl_account_code_material_closing)
    {
        if (!is_null($gl_account_code_material_closing) && (mb_strlen($gl_account_code_material_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_material_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeEquipment($gl_account_code_equipment)
    {
        if (!is_null($gl_account_code_equipment) && (mb_strlen($gl_account_code_equipment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_equipment when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeEquipmentDebit($gl_account_code_equipment_debit)
    {
        if (!is_null($gl_account_code_equipment_debit) && (mb_strlen($gl_account_code_equipment_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_equipment_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeEquipmentClosing($gl_account_code_equipment_closing)
    {
        if (!is_null($gl_account_code_equipment_closing) && (mb_strlen($gl_account_code_equipment_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_equipment_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeWaste($gl_account_code_waste)
    {
        if (!is_null($gl_account_code_waste) && (mb_strlen($gl_account_code_waste) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_waste when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeWasteDebit($gl_account_code_waste_debit)
    {
        if (!is_null($gl_account_code_waste_debit) && (mb_strlen($gl_account_code_waste_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_waste_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setGlAccountCodeWasteClosing($gl_account_code_waste_closing)
    {
        if (!is_null($gl_account_code_waste_closing) && (mb_strlen($gl_account_code_waste_closing) > 255)) {
            throw new \InvalidArgumentException('invalid length for $gl_account_code_waste_closing when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterSales($cost_center_sales)
    {
        if (!is_null($cost_center_sales) && (mb_strlen($cost_center_sales) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_sales when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterSalesDebit($cost_center_sales_debit)
    {
        if (!is_null($cost_center_sales_debit) && (mb_strlen($cost_center_sales_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_sales_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterPurchase($cost_center_purchase)
    {
        if (!is_null($cost_center_purchase) && (mb_strlen($cost_center_purchase) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_purchase when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterPurchaseDebit($cost_center_purchase_debit)
    {
        if (!is_null($cost_center_purchase_debit) && (mb_strlen($cost_center_purchase_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_purchase_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterHours($cost_center_hours)
    {
        if (!is_null($cost_center_hours) && (mb_strlen($cost_center_hours) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_hours when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterHoursDebit($cost_center_hours_debit)
    {
        if (!is_null($cost_center_hours_debit) && (mb_strlen($cost_center_hours_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_hours_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterMaterial($cost_center_material)
    {
        if (!is_null($cost_center_material) && (mb_strlen($cost_center_material) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_material when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterMaterialDebit($cost_center_material_debit)
    {
        if (!is_null($cost_center_material_debit) && (mb_strlen($cost_center_material_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_material_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterEquipment($cost_center_equipment)
    {
        if (!is_null($cost_center_equipment) && (mb_strlen($cost_center_equipment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_equipment when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterEquipmentDebit($cost_center_equipment_debit)
    {
        if (!is_null($cost_center_equipment_debit) && (mb_strlen($cost_center_equipment_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_equipment_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterWaste($cost_center_waste)
    {
        if (!is_null($cost_center_waste) && (mb_strlen($cost_center_waste) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_waste when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
    ...
    public function setCostCenterWasteDebit($cost_center_waste_debit)
    {
        if (!is_null($cost_center_waste_debit) && (mb_strlen($cost_center_waste_debit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cost_center_waste_debit when calling DivisionBranchWipSettings., must be smaller than or equal to 255.');
        }
