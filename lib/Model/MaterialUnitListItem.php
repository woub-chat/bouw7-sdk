...
/**
 * MaterialUnitListItem Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MaterialUnitListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MaterialUnitListItem';
     ...
     * Sets id
     *
     * @param int $id The ID of this material unit.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this material unit.
     *
     * @return $this
     */
